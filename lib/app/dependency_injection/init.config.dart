...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i13.AvailablePlatformsCubit>(() => integrationsModule
        .availablePlatformsCubit(gh<_i11.IntegrationsRepository>()));
    gh.factory<_i14.ForgotPasswordCubit>(() => authenticationModule
        .forgotPasswordCubit(gh<_i3.AuthenticationRepositoryContract>()));
    gh.lazySingleton<_i15.IntegrationsCubit>(() => integrationsModule
        .integrationsCubit(gh<_i11.IntegrationsRepository>()));
    gh.factory<_i16.SignInCubit>(() => authenticationModule
    ...
    gh.factory<_i18.SignUpCubit>(() => authenticationModule
